...
import { deleteUniversity } from "../../../configuration/TrainingApi";
...
const DeleteUniversity = () => {
  ...
  const handleDelete = async () => { 
    try {
      await deleteUniversity(tenantId,universityId);
  ...
  return (
    <Box sx={{ padding: 4, maxWidth: 500, margin: "0 auto", textAlign: "center" }}>
      ...
      <Typography variant="body1" sx={{ marginBottom: 3 }}>
        Are you sure you want to delete University name: <strong>{universityName}</strong>?
      </Typography>
      <Button
        variant="contained"
        color="error"
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog}>
        ...
        <DialogContent>
          <DialogContentText>
            Are you sure you want to permanently delete University name {universityName}? This action cannot be undone.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
