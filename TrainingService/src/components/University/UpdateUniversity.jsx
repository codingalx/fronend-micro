...
import { getLocationById, getUniversityById, updateUniversity } from "../../../configuration/TrainingApi";
...
const UpdateUniversity = () => {
  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    try {
      ...
      await updateUniversity(tenantId,universityId,data);
      resetForm();
  ...
  const refreshPage = () => {
    ...
    const [university, setUniversity] = useState({ 
      ...
      const fetchTrainingUniversity = async () => {
        try {
          const response = await getUniversityById(tenantId,universityId);
...
//   import { Formik } from "formik";
//   import Header from "../common/Header";
//   import { getUniversityById, updateUniversity } from "../../../configuration/TrainingApi";
//   import ToolbarComponent from "../TrainingCourse/ToolbarComponent";
//   import ToolbarComponent from "../TrainingCourse/ToolbarComponent";
// import { useLocation } from "react-router-dom";
...
//     const handleFormSubmit = async (values, { resetForm }) => {
//       try {
//         await updateUniversity(tenantId,universityId,values);
...
//         abbreviatedName: yup.string().required("Abbreviated name cannot be blank"),
//         costPerPerson: yup.number().nullable().required("Cost per person cannot be null"),
//          locationId: yup.string().required("Location name cannot be null"),
