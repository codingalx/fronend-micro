...
import { addAnnualTrainingRequest, listCourseCategory, listCourseTrainingByCategory, listOfBudgetYears, listTrainingInstution } from "../../../configuration/TrainingApi";
...
import ListAnnualTrainingRequest from "./ListAnnualTrainingRequest";




const CreateAnnualTrainingRequest = () => {
  ...
  const handleSaveDepartment = () => {
    ...
    const handleFormSubmit = async (values, { resetForm }) => {
        try {
            ...
            await addAnnualTrainingRequest(tenantId,formValues);
...
export default CreateAnnualTrainingRequest;
