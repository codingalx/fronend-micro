...
import {
  ...
  getAnnualTrainingById,
  updateAnnualTrainingRequest,getDepartementById
...
const EditAnnualTrainingRequest = () => {
  ...
  const fetchAnnualTrainingRequestById = async () => {
    try {
      const response = await getAnnualTrainingById(tenantId, trainingId);
  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    try {
      ...
      await updateAnnualTrainingRequest(tenantId, trainingId, formValues);
            ...
            >
              ...
              <FormControl fullWidth sx={{ gridColumn: "span 2" }}>
                ...
                >
                  ...
                  <MenuItem value="UNPLANNED_TRAINING">
                    UNPLANNED_TRAINING
                  </MenuItem>
                </Select>
              </FormControl>
...
//            trainingInstitutionId: yup.string().required("Department Name is required"),
