...
import { deleteAnnualTrainingRequest } from "../../../configuration/TrainingApi";
import { useAtom } from 'jotai';
import { authAtom } from 'shell/authAtom';

const DeleteAnnualTrainingRequest = () => {
  ...
  const handleDelete = async () => {
    try {
      await deleteAnnualTrainingRequest(tenantId,trainingId);
  ...
  return (
    <Box sx={{ padding: 4, maxWidth: 500, margin: "0 auto", textAlign: "center" }}>
      <Typography variant="h5" gutterBottom>
        Confirm Annula training requset Deletion
      </Typography>
      <Typography variant="body1" sx={{ marginBottom: 3 }}>
        Are you sure you want to delete training deletion with ID: <strong>{trainingId}</strong>?
      </Typography>
      <Button
        variant="contained"
        color="error"
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog}>
        ...
        <DialogContent>
          <DialogContentText>
            Are you sure you want to permanently delete annula training request with ID: {trainingId}? This action cannot be undone.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
...
export default DeleteAnnualTrainingRequest;
