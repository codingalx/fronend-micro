...
import { getDocuments, getPreServiceTrainingById, getPreServiceTrainingImageById, listEducationLevels, listFieldStudies, listOfBudgetYears, updatePreServiceTraining } from "../../../configuration/TrainingApi";
...
const UpdatePreServiceTraining = () => {
    ...
    const handleFormSubmit = async (values) => {
        try {
            ...
            const response = await updatePreServiceTraining(preServiceTrainingId, data);
