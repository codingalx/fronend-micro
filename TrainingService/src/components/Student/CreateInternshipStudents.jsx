...
import {  createInternshipStudents, listOfBudgetYears, listOfUniversity } from "../../../configuration/TrainingApi";
...
import ListInternshipStudents from './ListInternshipStudents'




const CreateInternshipStudents = () => {
  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    try {
      ...
      await createInternshipStudents(tenantId,data);
  ...
  return (
    <Box m="20px">
      ...
      />
      <Header subtitle="Create Student for Entern" />
      ...
      >
        ...
        {/* Snackbar for Notifications */}
          ...
          <ListInternshipStudents refreshKey={refreshKey}/>

    </Box>
  );
};

export default CreateInternshipStudents;
