...
import {  addTrainingparticipant, getEmployeeByEmployeId } from "../../../configuration/TrainingApi";
import ListTrainingParticipant from "./ListTrainingParticipant";
...
const CreateTrainingparticipant = () => {
  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    try {
      await addTrainingparticipant(tenantId,trainingId, values);
  ...
  return (
    <Box m="20px">
      ...
      <ListTrainingParticipant trainingId={trainingId} refreshKey={refreshKey}/>
