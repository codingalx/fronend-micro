...
const DecisionGatePassInformation = () => {
...
const handleFormSubmit = async (values, { resetForm }) => {
  ...
  try {
    await decisionGatePassInformation(tenantId,id, values);
    setNotification({
      open: true,
      message: "Decision gate pass infrmation is created successfully!",
      severity: "success",
    });
    resetForm();
  ...
  return (
    <Box m="20px">
      <Header subtitle="Make Decison of gate pass infomation " />
      <Formik
...
export default DecisionGatePassInformation;
