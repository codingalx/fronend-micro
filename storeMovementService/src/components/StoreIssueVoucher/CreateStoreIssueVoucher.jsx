...
import GetAllStoreIssueVoucher from "./GetAllStoreIssueVoucher";
...
const CreateStoreIssueVoucher = () => {
  ...
  const handleFormSubmit = async (values, { resetForm }) => {
    try {
      ...
      await createStoreIssueVouncher(tenantId, values);
      setNotification({
        open: true,
  ...
  return (
    <Box m="20px">
      <Header subtitle="Create store Issue vouncher " />
      <Formik
      ...
      >
       ...
       <GetAllStoreIssueVoucher refreshKey={refreshKey} />
    </Box>
  );
};
