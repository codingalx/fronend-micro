...
import GetAllFamilyDetail from "./GetAllFamilyDetail";

const CreateFamilyDetail = () => {
    ...
    const handleFormSubmit = async (values, { resetForm }) => {
        try {
            ...
            await createFamilyDetails({ ...values, employeeId });
            ...
            setNotification({
                open: true,
                message: "Failed create family details. Please try again.",
                severity: "error",
            });
        }
    };
    ...
    return (
        <Box m="20px">
            <Header subtitle="Create Family Details" />
            <Formik
            ...
            <GetAllFamilyDetail refreshKey={refreshKey} />
        </Box>
    );
};

export default CreateFamilyDetail;
