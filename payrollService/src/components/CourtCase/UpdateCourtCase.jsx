...
const UpdateCourtCase = () => {
    ...
    const [courseCase, setCourseCase] = useState({
    ...
    const fetchAllCourseCase = async () => {
        try {
            const response = await getCourtCaseById(id);
            const data = response.data;
            setCourseCase(data);
        } catch (error) {
            console.error("Error fetching court case:", error.message);
        }
    };
    ...
    const handleFormSubmit = async (values, { resetForm }) => {
        try {
            ...
            await updateCourtCase(id, { ...values, employeeId });
            ...
            setNotification({
                open: true,
                message: "Failed to update court cases. Please try again.",
                severity: "error",
            });
        }
    };
