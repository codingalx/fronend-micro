...
import {
  createAllEmployeeEarningDeduction,
...
import GetAllAllEmployeeEarningDeduction from "./GetAllAllEmployeeEarningDeduction";

const CreateAllEmployeeEarningDeduction = () => {
 ...
 const handleFormSubmit = async (values, { resetForm }) => {
  ...
  return (
    <Box m="20px">
           ...
           <Box
            ...
            <Box display="flex" justifyContent="start" mt="20px">
              <Button type="submit" color="secondary" variant="contained">
                Create AllEmployeeEarningDeduction
              </Button>
            </Box>
          </form>
        )}
      ...
      <GetAllAllEmployeeEarningDeduction refreshKey={refreshKey} />
    </Box>
  );
};

export default CreateAllEmployeeEarningDeduction;
