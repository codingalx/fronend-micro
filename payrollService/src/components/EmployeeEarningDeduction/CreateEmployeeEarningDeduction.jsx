...
import GetAllEmployeeEarningDeduction from "./GetAllEmployeeEarningDeduction";

const CreateEmployeeEarningDeduction = () => {
...
const handleFormSubmit = async (values, { resetForm }) => {
  ...
  const selectedEarningDeduction = earningDeduction.find(
    ...
    console.error(
      "Failed to submit employee earning deduction form data:",
      error
    );
  ...
  return (
    <Box m="20px">
      <Header subtitle="Create Employee Earning Deduction" />
      <Formik
           ...
           <Box
            ...
            <Box display="flex" justifyContent="start" mt="20px">
              <Button type="submit" color="secondary" variant="contained">
                Create EmployeeEarningDeduction
              </Button>
            </Box>
          </form>
        )}
      ...
      <GetAllEmployeeEarningDeduction refreshKey={refreshKey} />
    </Box>
  );
};

export default CreateEmployeeEarningDeduction;
