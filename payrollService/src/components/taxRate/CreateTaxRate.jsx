...
import GetAllTaxRate from "./GetAllTaxRate";
import { createTaxRate, getAllBudgetYear, getAllTaxRate } from "../../../Api/payrollApi";
...
const CreateTaxRate = () => {
  ...
  try {
    ...
    setNotification({
      open: true,
      message: "TaxRate created successfully!",
      severity: "success",
    });
    resetForm();
    ...
    setNotification({
      open: true,
      message: "Failed to create tax rate. Please try again.",
      severity: "error",
    });
  }
};
  ...
  return (
    <Box m="20px">
      ...
      <GetAllTaxRate refreshKey={refreshKey} />
    </Box>
  );
};
