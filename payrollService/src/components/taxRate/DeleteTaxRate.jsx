...
import { deleteTaxRate } from "../../../Api/payrollApi";
...
const DeleteTaxRate = () => {
  ...
  const handleCloseDialog = () => {
    ...
    if (!id) {
      return <NotFoundHandle message="No taxrate selected for deletion."
       navigateTo="/payroll/create_tax_rate" />;
    }
  ...
  return (
    <Box sx={{ padding: 4, maxWidth: 500, margin: "0 auto", textAlign: "center" }}>
      ...
      <Typography variant="body1" sx={{ marginBottom: 3 }}>
        Are you sure you want to delete the selected tax rate: 
      </Typography>
      <Button
        variant="contained"
        color="error"
      ...
      <Dialog open={open} onClose={handleCloseDialog}>
        ...
        <DialogContent>
          <DialogContentText>
            Are you sure you want to permanently delete the taxrate selected This action cannot be undone.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
