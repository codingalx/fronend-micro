...
import { editApplicantCertificate, getApplicatantCertificatefileById,getApplicantCertificateById } from "../../../configuration/RecruitmentApp";
import { useAtom } from 'jotai';
import { authAtom } from 'shell/authAtom';


const EditApplicantCertificate = () => {
  ...
  const fetchFileOfTraining = async () => {
    try {
      const fileBlob = await getApplicatantCertificatefileById(tenantId,applicantId,trainingId);
  ...
  const fetchTraining = async () => {
    try {
      const response = await getApplicantCertificateById(tenantId,applicantId, trainingId);
  ...
  const handleFormSubmit = async (values) => {
    try {
      ...
      const response = await editApplicantCertificate( tenantId,applicantId, trainingId, formData); // Correct way to call the API function
...
export default EditApplicantCertificate;
