...
import { deleteApplicantEducations } from "../../../configuration/RecruitmentApp";
import { useAtom } from 'jotai';
import { authAtom } from 'shell/authAtom';

const DeleteApplicantEducation = () => {
  ...
  const handleDelete = async () => {
    try {
      await deleteApplicantEducations(tenantId,applicantId,educationId );
