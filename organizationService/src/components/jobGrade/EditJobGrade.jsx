    ...
    axios
      ...
      .then((response) => {
        ...
        // You can display a success message or redirect to another page
        {
          ...
          navigate('/manage_organization_info', { state: { activeTab: 0 } }); //
      ...
      .catch((error) => {
        ...
        setError("There was an error updating the job grade!");
        setSubmitting(false);
      });
  };
  ...
  return (
    <Box m="20px" className="insert-tenant">
      <Header
        ...
        subtitle="Edit an existing job grade profile"
      />
