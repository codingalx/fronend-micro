...
const EditJobCategory = () => {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    axios
      .put(`${url}/${tenantId}/update/${id}`, data, {
        headers,
      })
      .then((response) => {
        ...
        // You can display a success message or redirect to another page
        {
          ...
          navigate('/manage_organization_info', { state: { activeTab: 1 } }); //
      ...
      .catch((error) => {
        ...
        setError("There was an error updating the job category!");
        setSubmitting(false);
      });
  };
  ...
  return (
    <Box m="20px" className="insert-tenant">
      <Header
        ...
        subtitle="Edit an existing job category profile"
      />
