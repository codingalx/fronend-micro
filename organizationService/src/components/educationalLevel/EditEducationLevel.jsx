...
const EditEducationLevel = () => {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        {
          navigate('/manage_organization_info', { state: { activeTab: 3 } }); //
      ...
      .catch((error) => {
        ...
        setError("There was an error updating the educational level!");
        setSubmitting(false);
      });
  };
  ...
  return (
    <Box m="20px" className="insert-tenant">
      <Header
        subtitle="Edit an existing educational level profile"
      />
