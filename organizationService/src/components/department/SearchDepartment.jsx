...
const tenantsID = 1;
const apiEndpointGetDep = getAllDepartmentsEndpoint(tenantsID);
const apiEndpointGetType = getAllDepartmentTypesEndpoint(tenantsID);
  ...
  return (
    <Box m="20px">
      <Header
        ...
        subtitle="Search department list by Department Name, Established Date"
      />
      <Box
        m="40px 0 0 0"
        height="75vh"
