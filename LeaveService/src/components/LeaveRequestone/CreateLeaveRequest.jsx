...
import {
    ...
    getAllbudgetYears,
    getAllLeaveType,
    addLeaveRequest,getEmployeeByEmployeId
} from "../../../configuration/LeaveApi";
import { useAtom } from 'jotai';
import { authAtom } from 'shell/authAtom'; 
import LeaveRequestByEmployeeId from "./LeaveRequestByEmployeeId";
...
const CreateLeaveRequest = () => {
    ...
    console.log(`the tenant id is one ${tenantId}`)
