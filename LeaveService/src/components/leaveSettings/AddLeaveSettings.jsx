...
import ManageLeaveSettings from "./ManageLeaveSettings";
...
const AddLeaveSettings = () => {
  ...
  return (
    <Box m="20px" className="insert-tenant">
      <Header
        subtitle="Create a new leave settings profile"
      />
      <Formik
        initialValues={{
          leaveType: "",
      ...
      >
        {({
          ...
          isSubmitting,
          handleChange,
          // this is a formik method that is used to set the value of a form field
          setFieldValue,
        }) => (
          <Form>
            <Box
            ...
            {successMessage && (
              <span display="flex" className="success-message">
                Leave Settings is created successfully!
              </span>
            )}
          </Form>
        )}
      </Formik>
      <ManageLeaveSettings  refreshKey ={refreshKey}/>
    </Box>
  );
};
